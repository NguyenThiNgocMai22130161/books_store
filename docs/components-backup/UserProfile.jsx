  ...
  return (
    <div>
      <nav className="navbar">
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: 0 }}>
          ...
          <div className="navbar-nav">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); handleLogout(); }} className="text-muted">
      ...
      <form id="logoutForm" action="http://localhost:8080/logout" method="post" style={{ display: 'none' }}>
        {/* CSRF token would be needed here in production */}
      </form>
      ...
      <footer className="footer">
        <div className="container">
          ...
          <p>© 2026 Tiệm Sách Management. Thông tin tài khoản được mã hóa bảo mật.</p>
        </div>
      </footer>
    </div>
  );
