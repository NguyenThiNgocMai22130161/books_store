    ...
    <div>
      <nav className="navbar">
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div className="navbar-nav">
            ...
            <Link to="/orders" style={{ margin: 0, color: 'var(--primary)', fontWeight: 600 }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <footer className="footer">
        <div className="container">
          ...
          <p style={{ textAlign: 'center', marginBottom: '0.5rem' }}>© 2026 Tiệm Sách. Được xây dựng với Spring Boot & React</p>
          <p className="text-muted" style={{ textAlign: 'center', fontSize: '0.875rem' }}>Thương mại điện tử hiện đại - Mua sắm dễ dàng, tiện lợi</p>
        </div>
      </footer>
    </div>
  );
