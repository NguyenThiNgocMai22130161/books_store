      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p className="footer-description">
              Hệ thống quản lý và bán sách trực tuyến. 
              Mang đến trải nghiệm mua sắm sách tốt nhất cho bạn.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/books?category=Văn học">Văn học</Link></li>
              <li><Link to="/books?category=Khoa học">Khoa học</Link></li>
              <li><Link to="/books?category=Lịch sử">Lịch sử</Link></li>
              <li><Link to="/books?category=Kỹ năng">Kỹ năng sống</Link></li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-copyright">
            <p>© {currentYear} Tiệm Sách. Tất cả quyền được bảo lưu.</p>
